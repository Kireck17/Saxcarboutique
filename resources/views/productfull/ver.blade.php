<div class="p-6 sm:px-20 bg-yellow-500 border-b border-gray-200">
 ...
 <main class="grid place-items-center bg-blue-500">
  <section class="flex flex-col md:flex-row gap-11 py-10 px-5 bg-white rounded-md shadow-lg w-3/4  w-full">
    ...
    <div class="text-indigo-500 flex flex-col justify-between">
      ...
      <div>
        <small class="uppercase">Imagenes</small>
