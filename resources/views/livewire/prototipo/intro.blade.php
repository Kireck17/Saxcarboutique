<x-containers.secondary>
    <div class="flex flex-col space-y-6">
        <h6 class="text-black font-bold text-center text-4xl">
            Carrusel de fotos de todos los productos
        </h6>
        {{-- Inicio del carousel --}}
            ...
            <div class="w-full h-full relative px-6" x-data="{ activeSlide: 0, slides: [
                ...
                <template x-for="(slide,key) in slides" :key="key">
                    <div x-show="activeSlide === key" class="flex flex-col h-full items-center overflow-hidden">
                        <img class="w-3/4 sm:w-1/2 h-full" :src="slide" alt="">
                    </div>
                </template>
...
<x-containers.secondary>
    ...
    <a href="#" class="text-blue-500 font-bold text-center text-base hover:text-yellow-500">
        Ver mas
    </a>
